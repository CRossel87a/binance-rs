...
mod tests {
    ...
    fn build_signed_request() {
        ...
        let parameters: BTreeMap<String, String> = BTreeMap::new();
        let result =
            binance_api::util::build_signed_request_custom(parameters, recv_window, now).unwrap();
    ...
    fn to_i64() {
        ...
        assert_eq!(binance_api::util::to_i64(&value_max), i64::MAX);
        assert_eq!(binance_api::util::to_i64(&value_min), i64::MIN);
    }
